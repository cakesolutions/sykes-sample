...
object MessageGenerator {
  ...
  /**
    ...
    */
  def message(companion: GeneratedMessageCompanion[_]): Gen[_] = {
    ...
    def generatorsFromFields(fields: List[FieldDescriptor]): List[(FieldDescriptor, Gen[Any])] = {
      fields.map { field ⇒
        ...
        val fieldGen: Gen[Any] = field.getType match {
          ...
          case Type.INT32 ⇒ FieldGenerator.randomIntField(field.getName)
          ...
          case Type.STRING ⇒ FieldGenerator.randomStringField(field.getName)
